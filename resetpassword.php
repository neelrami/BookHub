...
<body ng-controller='rpcontroller'>
                ...
                -->
                    ...
                    <div class="row">
                        <div class="col m12 s12">
                            ...
                            <center>   
                                <button class="btn btn-large waves-effect waves-light" type="button" ng-click="rp()" name="action">Reset Password</button>
                           </center> 
                        <p class='display empty passwordmsg' >Please fill all the fields</p>  
